...
import { presentationForSemanticEvent } from './motion-lab/guardian/guardian-intent-map.js?v=20260807-v94';
...
function mountMousePet() {
  ...
  const championAudioUrl = championAudioOverride || new URL('./assets/tools-pet/champion-callout-trimmed.m4a?rev=20260807-v94', import.meta.url).href;
