...
- **Status:** Accepted / Frozen / Web-integrated; protocol semantics unchanged
...
The historical “Not released” label refers to the protocol freeze checkpoint,
not the current Web product publication. The current delivery and algorithm
optimization state is maintained in
`docs/experiments/INTELLIGENT_EXPORT_CURRENT_STATUS.md`.
