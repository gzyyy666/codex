...
def main() -> None:
    ...
    assert 'import { privateDatabase } from "./api.js?v=20260820-01";' in share
    ...
    assert '"./share.js?v=20260820-01"' in service_worker

    app = (PWA / "app.js").read_text(encoding="utf-8")
    assert 'register("./sw.js?v=20260820-01"' in app
