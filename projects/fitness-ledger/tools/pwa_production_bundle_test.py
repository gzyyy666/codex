...
def main() -> None:
    ...
    assert 'import { privateAccountIdentity, privateDatabase } from "./api.js?v=20260820-02";' in share
    ...
    assert '"./share.js?v=20260820-02"' in service_worker

    app = (PWA / "app.js").read_text(encoding="utf-8")
    assert 'register("./sw.js?v=20260820-02"' in app
