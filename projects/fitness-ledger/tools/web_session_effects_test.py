...
"""
    ...
    assert result["switchCount"] == 2 and result["switchesInRail"] and result["cursorStored"] == "off" and result["cursorDataset"] == "off", result
    assert result["syncStatus"] == "SYNCED" and result["reconciled"] and result["autoSyncStatusReads"] == 3, result
