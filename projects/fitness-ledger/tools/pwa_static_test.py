...
def main() -> None:
    ...
    assert 'PWA v1.1.9' in app_source
    ...
    assert 'fitness-ledger-pwa-v45' in service_worker
    assert '"./data-modules.js?v=20260911-05"' in service_worker
    assert 'register("./sw.js?v=20260911-05", { updateViaCache: "none" })' in app_source
