...
def main() -> None:
    ...
    assert manifest["start_url"] == "./?v=20260917-05"
    ...
    assert 'PWA v1.1.32 · build 2026.09.17.05' in app_source
    ...
    assert 'fitness-ledger-pwa-v69' in service_worker
    assert '"./data-modules.js?v=20260917-05"' in service_worker
    assert 'register("./sw.js?v=20260917-05", { updateViaCache: "none" })' in app_source
    assert 'manifest.webmanifest?v=20260917-05' in source
