...
def main() -> None:
    ...
    assert 'PWA v1.1.27' in app_source
    ...
    assert 'fitness-ledger-pwa-v63' in service_worker
    assert '"./data-modules.js?v=20260913-24"' in service_worker
    assert 'register("./sw.js?v=20260913-24", { updateViaCache: "none" })' in app_source
    ...
    assert "height:calc(5 * 1.55em + 16px)!important;" in css_source
    assert "height:calc(4 * 1.55em + 16px)!important;" in css_source
