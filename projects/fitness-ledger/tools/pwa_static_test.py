...
def main() -> None:
    ...
    assert 'PWA v1.1.17' in app_source
    ...
    assert 'fitness-ledger-pwa-v53' in service_worker
    assert '"./data-modules.js?v=20260911-13"' in service_worker
    assert 'register("./sw.js?v=20260911-13", { updateViaCache: "none" })' in app_source
