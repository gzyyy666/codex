...
def main() -> None:
    ...
    assert 'PWA v1.1.16' in app_source
    ...
    assert 'fitness-ledger-pwa-v52' in service_worker
    assert '"./data-modules.js?v=20260911-12"' in service_worker
    assert 'register("./sw.js?v=20260911-12", { updateViaCache: "none" })' in app_source
