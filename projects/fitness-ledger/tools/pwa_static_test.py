...
def main() -> None:
    ...
    assert 'PWA v1.1.15' in app_source
    ...
    assert 'fitness-ledger-pwa-v51' in service_worker
    assert '"./data-modules.js?v=20260911-11"' in service_worker
    assert 'register("./sw.js?v=20260911-11", { updateViaCache: "none" })' in app_source
