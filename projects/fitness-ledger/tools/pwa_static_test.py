...
def main() -> None:
    ...
    assert manifest["start_url"] == "./?v=20260917-07"
    ...
    assert 'PWA v1.1.32 · build 2026.09.17.07' in app_source
    ...
    assert 'fitness-ledger-pwa-v71' in service_worker
    assert '"./data-modules.js?v=20260917-07"' in service_worker
    assert '"./styles-caret-gap-page-blank.css"' in service_worker
    assert 'register("./sw.js?v=20260917-07", { updateViaCache: "none" })' in app_source
    assert 'styles-caret-gap-page-blank.css' in source
    assert 'manifest.webmanifest?v=20260917-07' in source
