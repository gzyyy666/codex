...
def main() -> None:
    ...
    assert 'PWA v1.1.14' in app_source
    ...
    assert 'fitness-ledger-pwa-v50' in service_worker
    assert '"./data-modules.js?v=20260911-10"' in service_worker
    assert 'register("./sw.js?v=20260911-10", { updateViaCache: "none" })' in app_source
