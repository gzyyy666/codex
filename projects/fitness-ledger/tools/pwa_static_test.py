...
def main() -> None:
    ...
    for marker in ("shareDraft", "sendTrainingNote", "share-confirm-primary", "PHONE_INBOX_LIMIT", "privateDatabase", "确认发送"):
    ...
    assert 'register("./sw.js?v=20260816-02", { updateViaCache: "none" })' in app_source
