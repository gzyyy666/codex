...
def main() -> None:
    ...
    assert 'PWA v1.1.22' in app_source
    ...
    assert 'fitness-ledger-pwa-v58' in service_worker
    assert '"./data-modules.js?v=20260913-19"' in service_worker
    assert 'register("./sw.js?v=20260913-19", { updateViaCache: "none" })' in app_source
    ...
    assert "html.pwa-note-focused .reference-home .theme-strip" in css_source
    assert "html.pwa-note-focused .reference-home .theme-archive" in css_source
