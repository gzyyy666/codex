...
def main() -> None:
    ...
    assert 'PWA v1.1.13' in app_source
    ...
    assert 'fitness-ledger-pwa-v49' in service_worker
    assert '"./data-modules.js?v=20260911-09"' in service_worker
    assert 'register("./sw.js?v=20260911-09", { updateViaCache: "none" })' in app_source
