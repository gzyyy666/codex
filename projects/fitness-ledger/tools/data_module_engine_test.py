...
class DataModuleCandidateTests(unittest.TestCase):
    ...
    def test_template_statistics_and_release_readiness_are_local_and_bounded(self) -> None:
        ...
        self.assertEqual(template["template_version"], 10)
        ...
        self.assertEqual(template["behavior_contract"]["training_record_prefix"], "exactly_one_ascii_space_before_every_nonempty_training_block_line")
        self.assertEqual(template["behavior_contract"]["superset_contract"], "explicit standalone indented superset line before movement blocks: superset: A = movement 1, movement 2; preserve independent movement numbering and order")
