...
def main() -> None:
    ...
    reference_json = json.loads((ROOT / "miniprogram" / "pages" / "reference" / "index.json").read_text(encoding="utf-8"))
    assert reference_json["usingComponents"]["freeform-notepad"] == "/components/freeformNotepad/index"
