...
def main() -> None:
    ...
    try:
        ...
        assert "fitness-ledger-llm-entry-template-v2" in browser.evaluate("document.querySelector('.entry-template-json').textContent")
        assert browser.evaluate("document.querySelector('.entry-template-prompt').textContent.includes('Daily Entry')")
