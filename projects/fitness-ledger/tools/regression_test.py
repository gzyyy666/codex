...
assert not any("引体向上" in issue["issue"] and "没有可用于成长曲线" in issue["issue"] for issue in issues)
...
assert not any(issue["date"] == "2099-07-02" and "没有可用于成长曲线" in issue["issue"] for issue in pull_up_issues)
pull_up["history"].pop()
