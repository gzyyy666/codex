...
if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw-blur-height-fix.js?v=20260919-03", { updateViaCache: "none" }).catch(() => {});
