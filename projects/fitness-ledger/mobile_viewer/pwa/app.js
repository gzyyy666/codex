...
const BUILD_VERSION = "PWA v1.1.6 · build 2026.08.26.03";
...
if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw.js?v=20260826-03", { updateViaCache: "none" }).catch(() => {});
