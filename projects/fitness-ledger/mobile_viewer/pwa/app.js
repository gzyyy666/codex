...
const BUILD_VERSION = "PWA v1.1.22 · build 2026.09.13.19";
...
if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw.js?v=20260913-19", { updateViaCache: "none" }).catch(() => {});
