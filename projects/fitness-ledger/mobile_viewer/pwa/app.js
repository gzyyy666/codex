...
const BUILD_VERSION = "PWA v1.1.9 · build 2026.09.11.05";
...
if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw.js?v=20260911-05", { updateViaCache: "none" }).catch(() => {});
