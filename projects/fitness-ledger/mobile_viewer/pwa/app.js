...
const BUILD_VERSION = "PWA v1.0.0 · build 2026.08.03.21";
...
if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw.js?v=20260803-19", { updateViaCache: "none" }).catch(() => {});
